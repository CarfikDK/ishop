    ...
    <div class="container">
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <?php if($product->old_price): ?>
                                <del id="old-price" data-base="<?= $product->old_price * $curr['value']; ?>"><?=$curr['symbol_left'];?><?=$product->old_price * $curr['value'];?><?=$curr['symbol_right'];?></del>
                            <?php endif; ?>'
                            <?=$product->content;?>
                            <div class="available">
                                <ul>
                                    <li>Color
                                        <select>
                                            ...
                                            <?php foreach ($mods as $mod) : ?>
                                                <option data-title="<?= $mod->title; ?>", data-price="<?= $mod->price * $curr['value'];?>", data-oldPrice="<?= $mod->old_price * $curr['value'];?>", value="<?= $mod->id; ?>"><?= $mod['title']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </li>
                                </ul>
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    <h3><?= $item['title'];?></h3>
                                    <p>Explore Now</p>
                                    <h4><a class="add-to-cart-link" href="cart/add?id=<?=$item['id'];?>" data-id="<?=$item['id'];?>"><i></i></a>
                                        <span class=" item_price"><?=$curr['symbol_left'];?><?=$item['price'] * $curr['value'];?><?=$curr['symbol_right'];?></h5>
                ...
                <div class="latestproducts">
                    <div class="product-one">
                        <h3>Раньше вы заходили на эти товары:</h3>
